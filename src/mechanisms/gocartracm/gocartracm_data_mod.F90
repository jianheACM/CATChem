...
! Jian.He@noaa.gov, 
! 05/2023,  Move to parameters folder for CATChem
! 08/2023, Update for gocartracm 
...
module catchem_config
  ...
  integer :: chem_opt = 301
  integer :: phot_opt = 1 ! JH
  integer :: kemit = 1
  integer :: dust_opt = 5
  ...
  integer, parameter :: chem_tune_tracers = 20 ! JH: may need update if use wet_ls_alpha
  ...
  ! --
  integer, parameter :: call_chemistry     = 1  !JH, we need update this
  integer, parameter :: num_ebu            = 7 !JH, we set for now
  integer, parameter :: num_ebu_in         = 7 !JH, may need more in the input
  integer, parameter :: num_moist=3, num_chem=67, num_emis_seas=5, num_emis_dust=5  !JH
  ...
  integer :: numgas = 51   !JH (including DMS and MSA for drydep)
  ...
  integer, parameter :: p_no2  = 3
  integer, parameter :: p_no  = 4
  integer, parameter :: p_o3  = 5
  integer, parameter :: p_hno3  = 6
  integer, parameter :: p_h2o2  = 7
  integer, parameter :: p_ald  = 8
  integer, parameter :: p_hcho  = 9
  integer, parameter :: p_op1  = 10
  integer, parameter :: p_op2  = 11
  integer, parameter :: p_paa  = 12
  integer, parameter :: p_ora1  = 13
  integer, parameter :: p_ora2  = 14
  integer, parameter :: p_nh3  = 15
  integer, parameter :: p_n2o5  = 16
  integer, parameter :: p_no3  = 17
  integer, parameter :: p_pan  = 18
  integer, parameter :: p_hc3  = 19
  integer, parameter :: p_hc5  = 20
  integer, parameter :: p_hc8  = 21
  integer, parameter :: p_eth  = 22
  integer, parameter :: p_co  = 23
  integer, parameter :: p_ete  = 24
  integer, parameter :: p_olt  = 25
  integer, parameter :: p_oli  = 26
  integer, parameter :: p_tol  = 27
  integer, parameter :: p_xyl  = 28
  integer, parameter :: p_aco3  = 29
  integer, parameter :: p_tpan  = 30
  integer, parameter :: p_hono  = 31
  integer, parameter :: p_hno4  = 32
  integer, parameter :: p_ket  = 33
  integer, parameter :: p_gly  = 34
  integer, parameter :: p_mgly  = 35
  integer, parameter :: p_dcb  = 36
  integer, parameter :: p_onit  = 37
  integer, parameter :: p_csl  = 38
  integer, parameter :: p_iso  = 39
  integer, parameter :: p_co2  = 40
  integer, parameter :: p_ch4  = 41
  integer, parameter :: p_udd  = 42
  integer, parameter :: p_hket  = 43
  integer, parameter :: p_api  = 44
  integer, parameter :: p_lim  = 45
  integer, parameter :: p_dien  = 46
  integer, parameter :: p_macr  = 47
  integer, parameter :: p_ho  = 48
  integer, parameter :: p_ho2  = 49
  integer, parameter :: p_dms  = 50
  integer, parameter :: p_msa  = 51
  ! 16 more for GOCART
  integer, parameter :: p_p25  = 52
  integer, parameter :: p_bc1  = 53
  integer, parameter :: p_bc2  = 54
  integer, parameter :: p_oc1  = 55
  integer, parameter :: p_oc2  = 56
  integer, parameter :: p_dust_1  = 57
  integer, parameter :: p_dust_2  = 58
  integer, parameter :: p_dust_3  = 59
  integer, parameter :: p_dust_4  = 60
  integer, parameter :: p_dust_5  = 61
  integer, parameter :: p_seas_1  = 62
  integer, parameter :: p_seas_2  = 63
  integer, parameter :: p_seas_3  = 64
  integer, parameter :: p_seas_4  = 65
  integer, parameter :: p_seas_5  = 66
  integer, parameter :: p_p10  = 67
...
!  http://atmos.nmsu.edu/education_and_outreach/encyclopedia/humidity.htm
  ...
  !-- plumerise 
  !JH: anthro index, need to in the same order as ebu
  ...
  integer, parameter :: p_e_iso = 8
  integer, parameter :: p_e_no = 9
  integer, parameter :: p_e_no2 = 10
  integer, parameter :: p_e_co = 11
  integer, parameter :: p_e_eth = 12
  integer, parameter :: p_e_hc3 = 13
  integer, parameter :: p_e_hc5 = 14
  integer, parameter :: p_e_hc8 = 15
  integer, parameter :: p_e_xyl = 16
  integer, parameter :: p_e_olt = 17
  integer, parameter :: p_e_oli = 18
  integer, parameter :: p_e_tol = 19
  integer, parameter :: p_e_csl = 20
  integer, parameter :: p_e_hcho = 21
  integer, parameter :: p_e_ald = 22
  integer, parameter :: p_e_ket = 23
  integer, parameter :: p_e_ora2 = 24
  integer, parameter :: p_e_nh3 = 25
...
!  integer, parameter :: p_ebu_iso = 1
!  integer, parameter :: p_ebu_so2 = 2
!  integer, parameter :: p_ebu_no = 3
!  integer, parameter :: p_ebu_no2=4
!  integer, parameter :: p_ebu_co =5
!  integer, parameter :: p_ebu_eth=6
...
!  integer, parameter :: p_ebu_csl=14
!  integer, parameter :: p_ebu_hcho=15
!  integer, parameter :: p_ebu_ald=16
!  integer, parameter :: p_ebu_ket=17
!  integer, parameter :: p_ebu_ora2=18
!  integer, parameter :: p_ebu_nh3=19
!  integer, parameter :: p_ebu_pm25=20
!  integer, parameter :: p_ebu_pm10=21
!  integer, parameter :: p_ebu_oc=22
!  integer, parameter :: p_ebu_sulf=23
!  integer, parameter :: p_ebu_bc=24
!  integer, parameter :: p_ebu_dms=25
!
!  integer, parameter :: p_ebu_in_iso = 1
!  integer, parameter :: p_ebu_in_so2 = 2
!  integer, parameter :: p_ebu_in_no = 3
!  integer, parameter :: p_ebu_in_no2=4
!  integer, parameter :: p_ebu_in_co =5
!  integer, parameter :: p_ebu_in_eth=6
...
!  integer, parameter :: p_ebu_in_csl=14
!  integer, parameter :: p_ebu_in_hcho=15
!  integer, parameter :: p_ebu_in_ald=16
!  integer, parameter :: p_ebu_in_ket=17
!  integer, parameter :: p_ebu_in_ora2=18
!  integer, parameter :: p_ebu_in_nh3=19
!  integer, parameter :: p_ebu_in_pm25=20
!  integer, parameter :: p_ebu_in_pm10=21
!  integer, parameter :: p_ebu_in_oc=22
!  integer, parameter :: p_ebu_in_sulf=23
!  integer, parameter :: p_ebu_in_bc=24
!  integer, parameter :: p_ebu_in_dms=25
