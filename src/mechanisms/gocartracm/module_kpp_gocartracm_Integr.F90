...
! 
! File                 : gocartracm_Integrator.f90
! Time                 : Fri May 15 12:45:38 2015
! Working directory    : /scratch2/portfolios/BMC/wrf-chem/wrfchemv37/WRFV3_08may2015/chem/KPP/mechanisms/gocartracm
...
SUBROUTINE  gocartracm_INTEGRATE( TIN, TOUT, &
  FIX, VAR,  RCONST, ATOL, RTOL,           &
  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, IERR_U  )

   USE gocartracm_Parameters
!!   USE gocartracm_Global
   IMPLICIT NONE
   ...
   CALL gocartracm_Rosenbrock(VAR, FIX, RCONST, TIN,TOUT,   &
         ATOL,RTOL,               &
...
END SUBROUTINE  gocartracm_INTEGRATE

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE  gocartracm_Rosenbrock(Y, FIX, RCONST, Tstart,Tend, &
           AbsTol,RelTol,            &
           RCNTRL,ICNTRL,RSTATUS,ISTATUS,IERR)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
...
!~~~>  The particular Rosenbrock method chosen
   ...
   ELSE
      ...
      CALL gocartracm_ros_ErrorMsg(-2,Tstart,ZERO,IERR)
      RETURN
   END IF
...
!~~~>   The maximum number of steps admitted
   ...
   ELSE
      ...
      CALL gocartracm_ros_ErrorMsg(-1,Tstart,ZERO,IERR)
      RETURN
   END IF

!~~~>  Unit roundoff (1+Roundoff>1)
   Roundoff = gocartracm_WLAMCH('E')
...
!~~~>  Lower bound on the step size: (positive value)
   ...
   ELSE
      ...
      CALL gocartracm_ros_ErrorMsg(-3,Tstart,ZERO,IERR)
      RETURN
   END IF
...
!~~~>  Step size can be changed s.t.  FacMin < Hnew/Hexit < FacMax
   ...
   ELSE
      ...
      CALL gocartracm_ros_ErrorMsg(-4,Tstart,ZERO,IERR)
      RETURN
   END IF
...
!~~~>  Check if tolerances are reasonable
    DO i=1,UplimTol
      IF ( (AbsTol(i) <= ZERO) .OR. (RelTol(i) <= 10.0_dp*Roundoff) &
        ...
        CALL gocartracm_ros_ErrorMsg(-5,Tstart,ZERO,IERR)
        RETURN
      END IF
    END DO
...
!~~~>   Initialize the particular Rosenbrock method
   SELECT CASE (Method)
     CASE (1)
       CALL gocartracm_Ros2(ros_S, ros_A, ros_C, ros_M, ros_E,   &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE (2)
       CALL gocartracm_Ros3(ros_S, ros_A, ros_C, ros_M, ros_E,   &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE (3)
       CALL gocartracm_Ros4(ros_S, ros_A, ros_C, ros_M, ros_E,   &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE (4)
       CALL gocartracm_Rodas3(ros_S, ros_A, ros_C, ros_M, ros_E, &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE (5)
       CALL gocartracm_Rodas4(ros_S, ros_A, ros_C, ros_M, ros_E, &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE DEFAULT
...
!~~~>  CALL Rosenbrock method
   CALL gocartracm_ros_Integrator(Y,Tstart,Tend,Texit,      &
        AbsTol, RelTol,                          &
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 SUBROUTINE  gocartracm_ros_ErrorMsg(Code,T,H,IERR)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 END SUBROUTINE  gocartracm_ros_ErrorMsg

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 SUBROUTINE  gocartracm_ros_Integrator (Y, Tstart, Tend, T,     &
        AbsTol, RelTol,                          &
!~~~> Rosenbrock method coefficients
        ros_S, ros_M, ros_E, ros_A, ros_C,       &
        ros_Alpha, ros_Gamma, ros_ELO, ros_NewF, &
...
TimeLoop: DO WHILE ( (Direction > 0).AND.((T-Tend)+Roundoff <= ZERO) &
   ...
   IF ( Nstp > Max_no_steps ) THEN  ! Too many steps
      CALL gocartracm_ros_ErrorMsg(-6,T,H,IERR)
      RETURN
   END IF
   IF ( ((T+0.1_dp*H) == T).OR.(H <= Roundoff) ) THEN  ! Step size too small
      CALL gocartracm_ros_ErrorMsg(-7,T,H,IERR)
      RETURN
   END IF
...
!~~~>   Compute the function at current time
   CALL gocartracm_FunTemplate(T,Y,Fcn0, RCONST, FIX, Nfun)

!~~~>  Compute the function derivative with respect to T
   IF (.NOT.Autonomous) THEN
      CALL gocartracm_ros_FunTimeDeriv ( T, Roundoff, Y, &
                Fcn0, dFdT, RCONST, FIX, Nfun )
   END IF

!~~~>   Compute the Jacobian at current time
   CALL gocartracm_JacTemplate(T,Y,Jac0, FIX, Njac, RCONST)

!~~~>  Repeat step calculation until current step accepted
UntilAccepted: DO

   CALL gocartracm_ros_PrepareMatrix(H,Direction,ros_Gamma(1), &
          Jac0,Ghimj,Pivot,Singular, Ndec,  Nsng )
   IF (Singular) THEN ! More than 5 consecutive failed decompositions
       CALL gocartracm_ros_ErrorMsg(-8,T,H,IERR)
       RETURN
   END IF
...
Stage: DO istage = 1, ros_S
      ...
      ! For the 1st istage the function has been computed previously
       IF ( istage == 1 ) THEN
         CALL gocartracm_WCOPY(NVAR,Fcn0,1,Fcn,1)
      ! istage>1 and a new function evaluation is needed at the current istage
       ELSEIF ( ros_NewF(istage) ) THEN
         CALL gocartracm_WCOPY(NVAR,Y,1,Ynew,1)
         DO j = 1, istage-1
           CALL gocartracm_WAXPY(NVAR,ros_A((istage-1)*(istage-2)/2+j), &
            K(NVAR*(j-1)+1),1,Ynew,1)
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL gocartracm_FunTemplate(Tau,Ynew,Fcn, RCONST, FIX, Nfun)
       END IF ! if istage == 1 elseif ros_NewF(istage)
       CALL gocartracm_WCOPY(NVAR,Fcn,1,K(ioffset+1),1)
       DO j = 1, istage-1
         HC = ros_C((istage-1)*(istage-2)/2+j)/(Direction*H)
         CALL gocartracm_WAXPY(NVAR,HC,K(NVAR*(j-1)+1),1,K(ioffset+1),1)
       END DO
       IF ((.NOT. Autonomous).AND.(ros_Gamma(istage).NE.ZERO)) THEN
         HG = Direction*H*ros_Gamma(istage)
         CALL gocartracm_WAXPY(NVAR,HG,dFdT,1,K(ioffset+1),1)
       END IF
       CALL gocartracm_ros_Solve(Ghimj, Pivot, K(ioffset+1), Nsol)
...
!~~~>  Compute the new solution
   CALL gocartracm_WCOPY(NVAR,Y,1,Ynew,1)
   DO j=1,ros_S
         CALL gocartracm_WAXPY(NVAR,ros_M(j),K(NVAR*(j-1)+1),1,Ynew,1)
   END DO

!~~~>  Compute the error estimation
   CALL gocartracm_WSCAL(NVAR,ZERO,Yerr,1)
   DO j=1,ros_S
        CALL gocartracm_WAXPY(NVAR,ros_E(j),K(NVAR*(j-1)+1),1,Yerr,1)
   END DO
   Err = gocartracm_ros_ErrorNorm ( Y, Ynew, Yerr, AbsTol, RelTol, VectorTol )
...
!~~~>  Check the error magnitude and adjust step size
   ...
   IF ( (Err <= ONE).OR.(H <= Hmin) ) THEN  !~~~> Accept step
      Nacc = Nacc+1
      CALL gocartracm_WCOPY(NVAR,Ynew,1,Y,1)
      T = T + Direction*H
...
!~~~> Succesful exit
  ...
  END SUBROUTINE  gocartracm_ros_Integrator


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  REAL(kind=dp) FUNCTION  gocartracm_ros_ErrorNorm ( Y, Ynew, Yerr, &
...
! Local variables
   ...
   Err  = SQRT(Err/NVAR)
    ...
    gocartracm_ros_ErrorNorm = Err

  END FUNCTION  gocartracm_ros_ErrorNorm


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE gocartracm_ros_FunTimeDeriv ( T, Roundoff, Y, &
                Fcn0, dFdT, RCONST, FIX, Nfun )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Local variables
   ...
   CALL gocartracm_FunTemplate(T+Delta,Y,dFdT, RCONST, FIX, Nfun)
   CALL gocartracm_WAXPY(NVAR,(-ONE),Fcn0,1,dFdT,1)
   CALL gocartracm_WSCAL(NVAR,(ONE/Delta),dFdT,1)

  END SUBROUTINE  gocartracm_ros_FunTimeDeriv


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE  gocartracm_ros_PrepareMatrix ( H, Direction, gam, &
             Jac0, Ghimj, Pivot, Singular, Ndec,  Nsng  )
! --- --- --- --- --- --- --- --- --- --- --- --- ---
...
#ifdef FULL_ALGEBRA    
     CALL gocartracm_WCOPY(NVAR*NVAR,Jac0,1,Ghimj,1)
     CALL gocartracm_WSCAL(NVAR*NVAR,(-ONE),Ghimj,1)
     ghinv = ONE/(Direction*H*gam)
     DO i=1,NVAR
       Ghimj(i,i) = Ghimj(i,i)+ghinv
     END DO
#else
     CALL gocartracm_WCOPY(LU_NONZERO,Jac0,1,Ghimj,1)
     CALL gocartracm_WSCAL(LU_NONZERO,(-ONE),Ghimj,1)
     ghinv = ONE/(Direction*H*gam)
     DO i=1,NVAR
...
!~~~>    Compute LU decomposition
     CALL gocartracm_ros_Decomp( Ghimj, Pivot, ising, Ndec )
     IF (ising == 0) THEN
!~~~>    If successful done
        Singular = .FALSE.
     ELSE ! ising .ne. 0
!~~~>    If unsuccessful half the step size; if 5 consecutive fails then return
  ...
  END SUBROUTINE  gocartracm_ros_PrepareMatrix


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE  gocartracm_ros_Decomp( A, Pivot, ising, Ndec )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#ifdef FULL_ALGEBRA    
   CALL  gocartracm_DGETRF( NVAR, NVAR, A, NVAR, Pivot, ising )
#else   
!!!  use direct adressing in decomp 
!!!    CALL gocartracm_KppDecomp ( A, ising )
CALL decomp_gocartracm ( A, ising )
   Pivot(1) = 1
#endif
   Ndec = Ndec + 1

  END SUBROUTINE  gocartracm_ros_Decomp


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE  gocartracm_ros_Solve( A, Pivot, b, Nsol )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#ifdef FULL_ALGEBRA    
   CALL  gocartracm_DGETRS( 'N', NVAR , 1, A, NVAR, Pivot, b, NVAR, 0 )
#else   
   CALL gocartracm_KppSolve( A, b )
#endif

   Nsol = Nsol+1

  END SUBROUTINE  gocartracm_ros_Solve



!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE  gocartracm_Ros2 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
...
!~~~> Gamma_i = \sum_j  gamma_{i,j}
 ...
 END SUBROUTINE  gocartracm_Ros2


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE  gocartracm_Ros3 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
           ros_Gamma,ros_NewF,ros_ELO,ros_Name)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Gamma_i = \sum_j  gamma_{i,j}
  ...
  END SUBROUTINE  gocartracm_Ros3

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE  gocartracm_Ros4 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
           ros_Gamma,ros_NewF,ros_ELO,ros_Name)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Gamma_i = \sum_j  gamma_{i,j}
  ...
  END SUBROUTINE  gocartracm_Ros4

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE  gocartracm_Rodas3 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
            ros_Gamma,ros_NewF,ros_ELO,ros_Name)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Gamma_i = \sum_j  gamma_{i,j}
  ...
  END SUBROUTINE  gocartracm_Rodas3

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE  gocartracm_Rodas4 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
             ros_Gamma,ros_NewF,ros_ELO,ros_Name)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!        main and the embedded scheme orders plus 1
  ...
  END SUBROUTINE  gocartracm_Rodas4

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!   End of the set of internal Rosenbrock subroutines
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
END SUBROUTINE  gocartracm_Rosenbrock
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE  gocartracm_FunTemplate( T, Y, Ydot, RCONST, FIX, Nfun )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   USE gocartracm_Parameters
!! USE gocartracm_Global
!! USE gocartracm_Function
!! USE gocartracm_Rates
!~~~> Input variables
...
!!   CALL Update_SUN()
!!   CALL Update_RCONST()
   CALL gocartracm_Fun( Y, FIX, RCONST, Ydot )
!!   TIME = Told

   Nfun = Nfun+1

END SUBROUTINE  gocartracm_FunTemplate


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE  gocartracm_JacTemplate( T, Y, Jcb, FIX, Njac, RCONST )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!!    CALL Update_RCONST()
#ifdef FULL_ALGEBRA    
    CALL gocartracm_Jac_SP(Y, FIX, RCONST, JV)
    DO j=1,NVAR
      DO i=1,NVAR
         Jcb(i,j) = 0.0d0
      END DO
    ...
    END DO
#else
    CALL gocartracm_Jac_SP( Y, FIX, RCONST, Jcb )
#endif   
!!    TIME = Told

    Njac = Njac+1

END SUBROUTINE  gocartracm_JacTemplate
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! gocartracm_Fun - time derivatives of variables - Agregate form
!   Arguments :
...
SUBROUTINE gocartracm_Fun ( V, F, RCT, Vdot )
...
END SUBROUTINE gocartracm_Fun

! End of gocartracm_Fun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! gocartracm_Jac_SP - the Jacobian of Variables in sparse matrix representation
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
SUBROUTINE gocartracm_Jac_SP ( V, F, RCT, JVS )
...
END SUBROUTINE gocartracm_Jac_SP

! End of gocartracm_Jac_SP function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE gocartracm_KppDecomp( JVS, IER )
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
END SUBROUTINE gocartracm_KppDecomp


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE gocartracm_KppDecompCmplx( JVS, IER )
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
END SUBROUTINE gocartracm_KppDecompCmplx

! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE gocartracm_KppSolveIndirect( JVS, X )
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
END SUBROUTINE gocartracm_KppSolveIndirect

! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE gocartracm_KppSolveCmplx( JVS, X )
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
END SUBROUTINE gocartracm_KppSolveCmplx
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! gocartracm_KppSolve - sparse back substitution
!   Arguments :
!      JVS       - sparse Jacobian of variables
...
SUBROUTINE gocartracm_KppSolve ( JVS, X )
...
END SUBROUTINE gocartracm_KppSolve

! End of gocartracm_KppSolve function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!--------------------------------------------------------------
      SUBROUTINE gocartracm_WCOPY(N,X,incX,Y,incY)
!--------------------------------------------------------------
...
!     USE gocartracm_Precision
      ...
      END SUBROUTINE gocartracm_WCOPY


!--------------------------------------------------------------
      SUBROUTINE gocartracm_WAXPY(N,Alpha,X,incX,Y,incY)
!--------------------------------------------------------------
...
!      USE gocartracm_Precision
      ...
      END SUBROUTINE gocartracm_WAXPY



!--------------------------------------------------------------
      SUBROUTINE gocartracm_WSCAL(N,Alpha,X,incX)
!--------------------------------------------------------------
...
!      USE gocartracm_Precision
      ...
      END SUBROUTINE gocartracm_WSCAL

!--------------------------------------------------------------
      REAL(kind=dp) FUNCTION gocartracm_WLAMCH( C )
!--------------------------------------------------------------
...
!      USE gocartracm_Precision
      ...
      IF (First) THEN
        ...
        DO i = 17, 80
          Eps = Eps*HALF
          CALL gocartracm_WLAMCH_ADD(ONE,Eps,Sum)
...
10      Eps = Eps*2
      ...
      gocartracm_WLAMCH = Eps

      END FUNCTION gocartracm_WLAMCH
     
      SUBROUTINE gocartracm_WLAMCH_ADD( A, B, Sum )
!      USE gocartracm_Precision
      
      REAL(kind=dp) A, B, Sum
      Sum = A + B

      END SUBROUTINE gocartracm_WLAMCH_ADD
!--------------------------------------------------------------


!--------------------------------------------------------------
      SUBROUTINE gocartracm_SET2ZERO(N,Y)
!--------------------------------------------------------------
...
!--------------------------------------------------------------
      ...
      END SUBROUTINE gocartracm_SET2ZERO


!--------------------------------------------------------------
      REAL(kind=dp) FUNCTION gocartracm_WDOT (N, DX, incX, DY, incY) 
!--------------------------------------------------------------
...
!                                                                       
    5 IX = 1 
      ...
      DO i = 1,N 
        gocartracm_WDOT = gocartracm_WDOT + DX(IX)*DY(IY) 
        IX = IX + incX 
        IY = IY + incY 
      END DO 
      RETURN 
...
!                                                                       
   20 M = MOD(N,5) 
      IF (M .EQ. 0) GO TO 40 
      DO i = 1,M 
         gocartracm_WDOT = gocartracm_WDOT + DX(i)*DY(i) 
      END DO 
      IF (N .LT. 5) RETURN 
   40 MP1 = M + 1 
      DO i = MP1,N,5 
          gocartracm_WDOT = gocartracm_WDOT + DX(i)*DY(i) + DX(i+1)*DY(i+1) +&
                   DX(i+2)*DY(i+2) +  &
...
!                                                                       
   60 NS = N*incX 
      ...
      END FUNCTION gocartracm_WDOT                                          
! End of BLAS_UTIL function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


   SUBROUTINE decomp_gocartracm( JVS, IER )
  ...
  JVS( 1052) = W( 73 )
   ...
   END SUBROUTINE decomp_gocartracm
