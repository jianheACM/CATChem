      ...
      use catchem_constants, only : rdgas, rvgas
      ...
      use mo_chem_utls_mod, only : get_rxt_ndx, get_spc_ndx, get_tracer_ndx
...
logical                       :: module_is_initialized = .false.
      ...
      subroutine usrrxt_init( verbose, trop_option, tracer_names )
!-----------------------------------------------------------------
...
! check wiki for this, search get_tracer_ndx.
      so4_ndx     = get_tracer_ndx(tracer_names,'so4')
      nh4_ndx     = get_tracer_ndx(tracer_names,'nh4')
      nh4no3_ndx  = get_tracer_ndx(tracer_names,'nh4no3')
...
!                        dist=.false.)
     ...
     funit = 66
     open (funit,FILE='INPUT/am3_uptake.dat',action='read',status='old',form='formatted')
