...
module gfdl_sat_vapor_pres_mod
...
! </PUBLIC>
 ...
 use       catchem_constants, only:  TFREEZE, RDGAS, RVGAS, HLV, ES0
 use gfdl_sat_vapor_pres_k_mod, only:  sat_vapor_pres_init_k, lookup_es_k, &
...
! The default values below preserve the behavior of omsk and earlier revisions.
 ...
 logical :: use_exact_qs = .true.
 logical :: do_simple             =.false.
 logical :: construct_table_wrt_liq = .true.
 logical :: construct_table_wrt_liq_and_ice = .true.
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if (.not.module_is_initialized) then
      call errmsg('lookup_es','sat_vapor_pres_init is not called' ,.true.)
   endif
   ...
   if ( nbad == 0 ) then
     ...
     call errmsg('lookup_es',err_msg_local,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     call errmsg('lookup_es',err_msg_tmp,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_es2',err_msg_local,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_es2',err_msg_tmp,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_es3',err_msg_local,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_es3',err_msg_tmp,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_des',err_msg_local,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_des',err_msg_tmp,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_des2',err_msg_local,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_des2',err_msg_tmp,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_des3',err_msg_local,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_des3',err_msg_tmp,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_es2_des2',err_msg_local,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('lookup_es3_des3',err_msg_local,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('compute_qs',err_msg_tmp,.true.)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call errmsg('compute_mrs',err_msg_tmp,.true.)
   endif
...
!  =================================================================
  ...
  logical :: construct_table_wrt_liq, construct_table_wrt_liq_and_ice, &
             use_exact_qs
...
subroutine show_all_bad_0d ( temp )
 ...
 if (ind < 0 .or. ind > nlim) then
   ...
   write(*, '(a,e10.3,a,i6)') 'Bad temperature=',temp
 endif
...
!--------------------------------------------------------------
 ...
 do i=1,size(temp)
   ...
   if (ind < 0 .or. ind > nlim) then
     ...
     write(*, '(a,e10.3,a,i4,a,i6)') 'Bad temperature=',temp(i),'  at i=',i
   endif
 enddo
...
!--------------------------------------------------------------
 ...
 do i=1,size(temp,1)
   ...
   if (ind < 0 .or. ind > nlim) then
     ...
     write(*,'(a,e10.3,a,i4,a,i4,a,i6)') 'Bad temperature=',temp(i,j),'  at i=',i,' j=',j
   endif
 enddo
 enddo
...
!--------------------------------------------------------------
 ...
 do i=1,size(temp,1)
   ...
   if (ind < 0 .or. ind > nlim) then
     ...
     write(*,'(a,e10.3,a,i4,a,i4,a,i4,a,i6)') 'Bad temperature=',temp(i,j,k),' at i=',i,' j=',j
   endif
 enddo
 enddo
 enddo
...
!#######################################################################
end module gfdl_sat_vapor_pres_mod
!#######################################################################
