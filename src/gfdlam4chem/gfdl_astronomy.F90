...
!subroutines/functions adopted from astronomy.F90
                     
module gfdl_astronomy_mod

use gfdl_time_utls_mod, only: time_type, set_time, get_time, &
...
!!
!! \throw .true., "astronomy_mod ecc must be between 0 and 0.99"
!! \throw .true., "astronomy_mod obliquity must be between -90 and 90 degrees"
!! \throw .true., "astronomy_mod perihelion must be between 0 and 360 degrees"
...
!!
!! \throw .true., "astronomy_mod module has not been initialized"
...
!! \throw .true., "astronomy_mod ecc must be between 0 and 0.99"
!! \throw .true., "astronomy_mod obliquity must be between -90. and 90. degrees"
!! \throw .true., "astronomy_mod perihelion must be between 0.0 and 360. degrees"
...
!---------------------------------------------------------------------
      if (ecc_in < 0.0 .or. ecc_in > 0.99) &
        call errmsg ('astronomy_mod', &
                      'ecc must be between 0 and 0.99', .true.)
      if (obliq_in < -90.0 .or. obliq > 90.0) &
        call errmsg ('astronomy_mod', &
                'obliquity must be between -90. and 90. degrees', .true.)
      if (per_in < 0.0 .or. per_in > 360.0) &
        call errmsg ('astronomy_mod', &
              'perihelion must be between 0.0 and 360. degrees', .true.)
...
!! \param [out] <half_day_out> half_day_out
!!
!! \throw .true., "astronomy_mod time_since_ae not between 0 and 2pi"
!! \throw .true., "astronomy_mod gmt not between 0 and 2pi"
...
!---------------------------------------------------------------------
      if (time_since_ae < 0.0 .or. time_since_ae > twopi) &
          call errmsg('astronomy_mod', &
                    'time_since_ae not between 0 and 2pi', .true.)
...
!---------------------------------------------------------------------
      if (gmt < 0.0 .or. gmt > twopi) &
         call errmsg('astronomy_mod', &
                    'gmt not between 0 and 2pi', .true.)
...
!! \param [out] <half_day_out> half_day_out
!!
!! \throw .true., "astronomy_mod radiation time step must be no longer than 12 hrs"
!! \throw .true., "astronomy_mod radiation time step must not be an integral number of days"
...
!!
!! \throw .true., "astronomy_mod annual_mean_solar_2level should be called only once"
