!> \file WeselyScheme_Mod.F90
!! \brief Wesely scheme implementation for DryDep process
...
!! \version 1.0
!!
!! This module implements the wesely scheme for drydep processes.
...
!!     Deposition in Regional-Scale Numerical Models. Atmospheric Environment, 23, 1293-1304.
!!     http://dx.doi.org/10.1016/0004-6981(89)90153-4
!!
module WeselyScheme_Mod
   use precision_mod
   use constants_mod
