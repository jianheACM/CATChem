...
CONTAINS
   ...
   !! using the Gong 2003 parameterization.
   !!
   ...
   SUBROUTINE seasalt_scheme_gong03( &
      ...
      ! Gong 2003 parameters
      REAL(fp), PARAMETER :: a_factor = 3.0_fp
      REAL(fp), PARAMETER :: b_factor = 0.43_fp
      ...
      DO i_bin = 1, n_bins
         ...
         DO i_sub = 1, n_sub
            ...
            ! Calculate emission rate using Gong 2003 parameterization
   ...
   END SUBROUTINE seasalt_scheme_gong03
