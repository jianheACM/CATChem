!> \file OvadnevaiteScheme_Mod.F90
!! \brief Ovadnevaite scheme implementation for SeaSalt process
...
!! \version 1.0
!!
!! This module implements the ovadnevaite scheme for seasalt processes.
...
module OvadnevaiteScheme_Mod
   ...
   public :: ovadnevaite_scheme_run
   public :: ovadnevaite_scheme_configure
...
contains
   ...
   !> Configure Ovadnevaite scheme parameters
   subroutine ovadnevaite_scheme_configure(parameters, rc)
   ...
   end subroutine ovadnevaite_scheme_configure

   !> Run Ovadnevaite scheme for a single column
   !! This is a pure science kernel that operates on simple arrays
   subroutine ovadnevaite_scheme_run( &
   ...
   end subroutine ovadnevaite_scheme_run


end module OvadnevaiteScheme_Mod