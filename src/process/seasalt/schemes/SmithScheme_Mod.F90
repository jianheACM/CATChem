!> \file SmithScheme_Mod.F90
!! \brief Smith scheme implementation for SeaSalt process
...
!! \version 1.0
!!
!! This module implements the smith scheme for seasalt processes.
...
module SmithScheme_Mod
   ...
   public :: smith_scheme_run
   public :: smith_scheme_configure
...
contains
   ...
   !> Configure Smith scheme parameters
   subroutine smith_scheme_configure(parameters, rc)
   ...
   end subroutine smith_scheme_configure

   !> Run Smith scheme for a single column
   !! This is a pure science kernel that operates on simple arrays
   subroutine smith_scheme_run( &
   ...
   end subroutine smith_scheme_run


end module SmithScheme_Mod