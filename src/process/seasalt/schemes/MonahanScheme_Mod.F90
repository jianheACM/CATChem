!> \file MonahanScheme_Mod.F90
!! \brief Monahan scheme implementation for SeaSalt process
...
!! \version 1.0
!!
!! This module implements the monahan scheme for seasalt processes.
...
module MonahanScheme_Mod
   ...
   public :: monahan_scheme_run
   public :: monahan_scheme_configure
...
contains
   ...
   !> Configure Monahan scheme parameters
   subroutine monahan_scheme_configure(parameters, rc)
   ...
   end subroutine monahan_scheme_configure

   !> Run Monahan scheme for a single column
   ...
   end subroutine monahan_scheme_run


end module MonahanScheme_Mod