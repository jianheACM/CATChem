...
contains
   ...
   !! \param FRSEAICE Sea ice fraction
   !! \param U10M U-component of 10m wind speed
   !! \param V10M V-component of 10m wind speed
   !! \param SST Sea surface temperature
   !! \param WeibullFlag Weibull distribution flag
   !! \param SeaSaltScaleFactor Sea salt scaling factor
