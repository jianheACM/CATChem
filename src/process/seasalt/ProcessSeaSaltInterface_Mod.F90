...
!! Generation date: 2025-08-29T16:37:22.053727
...
contains
   ...
   subroutine process_init(this, container, rc)
      ...
      call this%process_config%load_species_from_chem_state(this%chem_state, error_manager, rc)
      if (rc /= CC_SUCCESS) then
         return
      end if
      ...
      if (this%process_config%seasalt_config%diagnostics) then
         ...
         select case (this%process_config%seasalt_config%scheme)
         case ("gong97")
   ...
   subroutine parse_seasalt_config(this, state_manager, error_manager, rc)
      ...
      call this%process_config%load_from_config(config_manager, error_manager, rc)
      if (rc /= CC_SUCCESS) then
         call error_manager%push_context("ProcessSeaSaltInterface: Failed to parse seasalt process configuration")
         return
      end if
   ...
   subroutine calculate_and_update_diagnostics(this, column, container, rc)
      ...
      case ("gong97")
         ...
         if (allocated(this%column_seasalt_mass_emission_per_bin)) then
            call this%update_1d_diagnostic_column('seasalt_mass_emission_per_bin', &
                                                this%column_seasalt_mass_emission_per_bin, &
                                                i_col, j_col, container, rc)
            if (rc /= CC_SUCCESS) return
         end if
         ...
         if (allocated(this%column_seasalt_number_emission_per_bin)) then
            call this%update_1d_diagnostic_column('seasalt_number_emission_per_bin', &
                                                this%column_seasalt_number_emission_per_bin, &
                                                i_col, j_col, container, rc)
            if (rc /= CC_SUCCESS) return
         end if
