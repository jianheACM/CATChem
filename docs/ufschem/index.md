...
*Figure 1: Conceptual Framework of UFS-Chem: He et al., in preparation for JAMES, 2025*
...
We will also add enhanced research capabilities into UFS-Chem, which will include:
  ...
  7. Further investment of model evaluation tools like **[MELODIES-MONET](https://csl.noaa.gov/groups/csl4/modeldata/melodies-monet/) that enable model comparison against a variety of observations
